...
watch(dateRange, (newRange) => {
    if (newRange[0] && newRange[1]) {
        router.get('/reports', {
            start_date: newRange[0].toISOString().split('T')[0],
            end_date: newRange[1].toISOString().split('T')[0],
            months: months.value,
            limit: limit.value,
        }, {
            preserveState: true,
...
// Watch for months/limit changes
watch([months, limit], () => {
    router.get('/reports', {
                ...
                <div v-if="props.permissions.generate" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div class="md:col-span-1">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <button @click="resetDateRange" class="p-2 text-gray-500 hover:text-gray-700">
